...
.flat.affineBackward:{[dout;cached]
    / cached expects `x`w`b
    origx:cached `x;
    shapex:origx 0;
    ...
    dout:dout 1;
    b:cached `b;
    dw:dot[flipFlat[x;shapexnew 0;shapexnew 1];shapexnew 1;shapexnew 0;dout;shapedout 0;shapedout 1];
    db:sumMatrixFlat[dout;shapedout 0;shapedout 1];
    dx:dot[dout;shapedout 0;shapedout 1;flipFlat[w;shapew 0;shapew 1];shapew 1;shapew 0];
...
.flat.affineReluBackward:{[dout;cache]
    / cache expects `x`w`b (affineBackward)
    fcCache:cache 0;
    reluCache:cache 1;
